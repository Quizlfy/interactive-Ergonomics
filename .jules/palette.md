...
## 2026-06-19 - Decorative Elements Need aria-hidden
**Learning:** Screen readers announce purely decorative visual elements like avatar initials, which creates redundant and noisy output for users.
**Action:** Apply `aria-hidden="true"` to purely decorative visual elements to streamline the screen reader experience.
