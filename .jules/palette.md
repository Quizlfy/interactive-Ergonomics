...
## 2026-07-04 - Hide decorative avatars from screen readers
**Learning:** Avatar initials displayed next to full names are redundant and can cause noisy/confusing screen reader announcements.
**Action:** Apply `aria-hidden="true"` to purely decorative visual elements like avatar initials to improve screen reader experience.
