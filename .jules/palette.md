...
## 2026-07-08 - Hide Decorative Avatars from Screen Readers
**Learning:** Avatar initials displayed next to a user's full name are purely decorative. Without `aria-hidden="true"`, screen readers will read the initials followed by the full name, causing a redundant and noisy experience.
