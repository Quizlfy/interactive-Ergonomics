...
## 2024-05-24 - Accessibility for Decorative Elements
**Learning:** Decorative elements like visual emojis (e.g., icons) and initials derived from full names (e.g., user avatars next to full names) cause screen readers to announce redundant or confusing information if not hidden.
**Action:** Always add `aria-hidden="true"` to these types of purely visual or duplicate elements in UI components.
