...
## 2024-06-13 - Hide Purely Decorative Elements from Screen Readers
**Learning:** Decorative emojis used as icons or initials generated as avatars can create "noisy" or confusing experiences for screen reader users (e.g., reading out "Chair Sacral Sitting" or "A A Abdulrahman Ali"). These elements provide purely visual flair and no unique semantic value.
**Action:** When making UX and accessibility improvements, always apply `aria-hidden="true"` to purely decorative visual elements (like avatar initials next to full names or decorative UI emojis) to prevent redundant screen reader announcements.
