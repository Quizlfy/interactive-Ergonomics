...
## 2026-06-29 - Hide purely decorative avatars from screen readers
**Learning:** Avatar initials placed next to full names create noisy and redundant announcements for screen reader users (e.g., 'A A Abdulrahman Ali').
**Action:** Apply `aria-hidden="true"` to purely visual avatar elements to streamline the screen reading experience.
