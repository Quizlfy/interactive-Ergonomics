...
## 2024-05-16 - Avatar Screen Reader Noise
**Learning:** Decorative avatar initials displayed alongside full names create redundant and noisy screen reader announcements.
**Action:** Apply `aria-hidden="true"` to decorative avatar elements to ensure a clean auditory experience.
