...
## 2024-06-17 - Hide Decorative Elements from Screen Readers
...
**Action:** Always apply `aria-hidden="true"` to such purely decorative visual elements to improve the screen reader experience.
