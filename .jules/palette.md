...
## 2026-06-28 - Purely Decorative Visual Elements
**Learning:** Icons and avatars that only serve a visual/decorative purpose should be hidden from screen readers to prevent redundant announcements.
**Action:** Apply `aria-hidden="true"` to decorative visual elements like avatar initials and icons next to full text.
