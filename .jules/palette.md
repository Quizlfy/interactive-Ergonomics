...
## 2024-05-20 - Decorative Elements Cause Screen Reader Noise
**Learning:** Purely decorative visual elements, such as avatar initials next to full names and decorative UI emojis, cause redundant and noisy announcements for screen reader users, degrading the experience.
**Action:** Always apply `aria-hidden="true"` to purely decorative visual elements (like avatar initials and UI emojis) to prevent noisy screen reader announcements.
